...
<div class="products_requestorders-container">
    ...
    <ul>
        ...
        <li><a  class="active2"  href="{{ route('admin.processing') }}">Processing</a></li>
        ...
        <table >
            ...
            @foreach ($items as $item)
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('admin.done_process', $item->id) }}" method="post">
                            @csrf
                            ...
                            color: white;
                            border-style: none;
                            border-radius: 5px;" value="Done" onclick="return confirm('Done Processing??');">
                        </form>
                        <br>
                    </td>
