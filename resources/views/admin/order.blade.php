...
<div class="products_requestorders-container">
    ...
    <button class="print">Print</button>
        <ul>
            <li><a class="active2"  href="{{ route('admin.order') }}">Orders</a></li>
            <li><a href="{{ route('admin.processing') }}">Processing</a></li>
            <li><a href="{{ route('admin.deliver') }}">To Deliver</a></li>
            ...
            @foreach ($items as $item)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('admin.accept', $item->id) }}" method="post">
                            @csrf
                            ...
                            color: white;
                            border-style: none;
                            border-radius: 5px;" value="Accept" onclick="return confirm('Are you sure you want to accept??');">
                        </form>
                        <br>
                        ...
                        border: 1px solid #ccc;
                            border-radius: 5px;" value="Reject" onclick="return confirm('Are you sure you want to reject??');">
                        </form>
                    </td>
