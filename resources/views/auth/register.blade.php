    ...
    <div class="login-container">
        <div class="card-body m-5">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row mb-3">
                    <div class="">
                        <input id="contact_number" type="text" class="form-control @error('contact_number') is-invalid @enderror" name="contact_number" value="{{ old('contact_number') }}" required autocomplete="contact_number" autofocus placeholder="Contact Number">
            ...
            <div class="d-flex justify-content-center mt-3">
                <label>Already have account? </label><a href="{{ route('login') }}">Login</a>
            </div>
            <br>
        </div>
